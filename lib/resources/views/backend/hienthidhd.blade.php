...
@section('title','Hiển thị đơn hàng đặt')
@section('main')
<main>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<ul class="nav menu navbar-nav" style="border:solid 1px black">
						<li class="active"><a href="{{asset('admin/donhang/hangdat')}}">Đơn hàng đặt</a></li>
						<li ><a href="{{asset('admin/donhang/hanghuy')}}">Đơn hàng hủy</a></li>
					</ul>
